...
const SPECIES := [
	...
	{"n": "Moonlit Zander", "t": "Rare", "h": "River Bend", "m": 64, "w": [3.0, 8.5], "v": 14, "d": "Eyes like lamp glass. Hunts the black water on nights the moon does the work for it.", "night": true, "pick": 0.7},
	...
	{"n": "Atlantic Croaker", "t": "Common", "h": "Brackish Shallows", "m": 127, "w": [0.3, 1.2], "v": 2, "d": "Grumbles from the bait bucket loud enough to hear over the wind."},
	...
	{"n": "Spotted Seatrout", "t": "Uncommon", "h": "Brackish Shallows", "m": 128, "w": [0.5, 2.0], "v": 5, "d": "Named for the spots, not the trout — it isn't one, but the name stuck generations ago."},
	...
	{"n": "Black Drum", "t": "Rare", "h": "Brackish Shallows", "m": 129, "w": [4.0, 11.0], "v": 12, "d": "Drums a low note against its own swim bladder that carries further underwater than it has any right to."},
	...
	{"n": "Cownose Ray", "t": "Epic", "h": "Brackish Shallows", "m": 131, "w": [15.0, 35.0], "v": 35, "d": "Travels in a wheeling raft of hundreds, all banking the same way at once."},
	...
	{"n": "Tin Mackerel", "t": "Common", "h": "Harbour", "m": 120, "w": [0.4, 1.4], "v": 2, "d": "Striped like hammered metal and never still for a second."},
	...
	{"n": "Mooring Conger", "t": "Uncommon", "h": "Harbour", "m": 124, "w": [2.0, 6.5], "v": 6, "d": "Lives under the stone quay. Every dockhand has an opinion on how big it really is."},
	...
	{"n": "Ballast Grouper", "t": "Rare", "h": "Harbour", "m": 125, "w": [6.0, 16.0], "v": 16, "d": "Took up residence in a scuttled hull and grew to fit the cabin."},
	...
	{"n": "Parrot Wrasse", "t": "Uncommon", "h": "Coral Shallows", "m": 70, "w": [1.0, 3.6], "v": 6, "d": "Grinds coral to sand with a beak like a nutcracker. The beaches are its leavings."},
	...
	{"n": "Napoleon Wrasse", "t": "Rare", "h": "Coral Shallows", "m": 121, "w": [6.0, 16.0], "v": 17, "d": "Grows a bulging forehead with age and follows divers around out of plain curiosity."},
	...
	{"n": "Albacore", "t": "Rare", "h": "Open Water", "m": 126, "w": [4.0, 12.0], "v": 16, "d": "Pale-fleshed and long-finned, running just under the surface in loose schools."},
	...
	{"n": "Yellowfin Tuna", "t": "Epic", "h": "Open Water", "m": 126, "w": [18.0, 45.0], "v": 40, "d": "Built entirely for speed, down to fins that fold into slots so as not to spoil the line."},
	...
	{"n": "Tiger Shark", "t": "Legendary", "h": "Open Water", "m": 132, "w": [45.0, 100.0], "v": 84, "d": "Eats anything, tests everything first, and carries the stripes to prove it's been doing this a while."},
	{"n": "Ocean Leviathan", "t": "Mythic", "h": "Open Water", "m": 31, "w": [120.0, 300.0], "v": 190, "d": "Charted as an island twice. Both charts were withdrawn."},
	{"n": "Megalodon", "t": "Secret", "h": "Open Water", "m": 133, "w": [350.0, 700.0], "v": 480, "d": "Extinct on every chart but this one. Surfaces only when the water is too calm to explain the wake.", "weather": "Sunny"},
	...
	{"n": "Spanish Mackerel", "t": "Rare", "h": "Storm Front", "m": 120, "w": [1.5, 5.0], "v": 14, "d": "Runs the surface in slashing schools whenever the barometer starts to drop.", "weather": "Stormy"},
	...
	{"n": "Thunderfin Tuna", "t": "Epic", "h": "Storm Front", "m": 126, "w": [22.0, 50.0], "v": 38, "d": "Chases the baitfish a storm drives to the surface, and doesn't stop for the swell.", "weather": "Stormy"},
	...
	{"n": "Haddock", "t": "Rare", "h": "Ice Shelf", "m": 123, "w": [1.5, 5.0], "v": 13, "d": "Marked with a dark thumbprint on each flank that never washes off or fades."},
	{"n": "Capelin", "t": "Rare", "h": "Ice Shelf", "m": 122, "w": [0.05, 0.2], "v": 12, "d": "Common enough offshore, but the shelf ice keeps most of the run out of any hook's reach."},
	...
	{"n": "Frilled Shark", "t": "Rare", "h": "Abyssal Trench", "m": 26, "w": [4.0, 12.0], "v": 17, "d": "Older in shape than the trench itself, more eel than shark until it opens its mouth."},
	...
	{"n": "Giant Squid", "t": "Epic", "h": "Abyssal Trench", "m": 130, "w": [30.0, 70.0], "v": 46, "d": "Comes up snarled around a whale's jaw more often than it comes up whole."},
